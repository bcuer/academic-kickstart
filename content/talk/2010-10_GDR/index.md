...
summary = "<b>Etude de simulations</b> avec des <b>modèles conjoints à risques concurrents</b> pour la prise en compte de différents types de <b>sorties d'études</b>."
...
Méthode
Le modèle conjoint considéré se décompose en un modèle linéaire mixte à coefficients aléatoires pour la trajectoire du score de QdV et un modèle à risques concurrents pour le temps jusqu’à sortie d’étude, tous deux étant liés par une structure d’association correspondant au score courant de QdV [1].
